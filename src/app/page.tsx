      ...
      if (uploadData.ocrSuccess && uploadData.data && uploadData.data.crl) {
        ...
        const confirmRes = await fetch('/api/student/scorecard/confirm', {
          ...
          body: JSON.stringify({
            ...
            pwbd: d.pwbd || false,
            stateOfEligibility: d.stateOfEligibility || '',
            gender: d.gender || '',
            dob: d.dob || '',
            s1Physics: d.s1Physics || null,
            s1Chemistry: d.s1Chemistry || null,
            s1Maths: d.s1Maths || null,
            s1Nta: d.s1Nta || null,
            s2Physics: d.s2Physics || null,
            s2Chemistry: d.s2Chemistry || null,
            s2Maths: d.s2Maths || null,
            s2Nta: d.s2Nta || null,
            finalNta: d.finalNta || null,
            crl: d.crl || 0,
